...
if(isset($_POST['login'])){
  require_once ($cwd.'classes/Admin.php');
  $admin = new Admin();
...
?>
  <body>
    <div class="container">
      ...
      <p>For test purposes the username is "dlor" the password is "password"</p>
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="username" value="dlor">
          </div>
        </div>
      </div>
      <div class="row">
